...
required_fragments = {
    ...
    "Yandex tile provider": "core-renderer-tiles.maps.yandex.net",
    "print-resolution tiles": "&scale=2",
    "Yandex attribution": "© Яндекс",
    "satellite basemap option": "Яндекс.Спутник",
