...
- Объекты с балансодержателем «АвД САО» и «ДЭУ» (в источнике ПП это ДЭУ 1, ДЭУ 2, ДЭУ 3) идут в счёт отдельной строки «АвД САО», а не района, на территории которого стоят: район их снимает, но объём работ учитывается владельцу. Туда же попадают объекты без района. Строка «ИТОГО по САО» — сумма строк таблицы.
