...
- Проценты на этом листе подсвечены светофором: до 33 % красный, 33–<66 % жёлтый, от 66 % зелёный. Цвета бледные и совпадают с полосами статуса в PDF; пустая ячейка остаётся без цвета.
...
- «На штаб» — короткая форма ОУИФР по типам объектов и отдельно по балансодержателям; план, факт и процент в отметках точек, проценты подсвечены светофором по тем же порогам, что и полосы статуса;
