...
- Раскладка листа — по эталону заказчика: «№» и «Район», три категории и «Итого», в каждой категории «План», «Факт», «%». Ниже та же таблица, отсортированная по «Итого, %» формулой `SORT`, и готовый текст комментария к рассылке — разбор именно этой выгрузки.
