...
OUT=DATA/'remaining_historical_pdf_color_review.csv'
MD=DATA/'remaining_historical_pdf_color_review.md'
J=DATA/'remaining_historical_pdf_color_review.json'
...
wave=json.loads((L/'sao_remaining_wgs84.geojson').read_text(encoding='utf-8'))
